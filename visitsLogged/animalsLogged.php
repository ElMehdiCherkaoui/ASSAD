    ...
    <header class="bg-primary text-white">
        <div class="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
            ...
            <nav class="space-x-6 text-sm font-medium">
                ...
                <a href="list-logged.php" class="hover:text-secondary">Animals</a>
                <a href="../visits/list.php" class="hover:text-secondary">Guided Visits</a>
                <a href="../visits/my-reservations.php" class="hover:text-secondary">My Reservations</a>
